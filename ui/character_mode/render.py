...
def render(settings: Dict[str, Any]) -> None:
    ...
    with tab_items:
        ...
        source_type_filter = set(st.session_state.get("cm_gf_source_type") or type_options)
        source_entity_filter = set(st.session_state.get("cm_gf_source_entity") or entity_options)
        legendary_mode = st.session_state.get("cm_gf_legendary") or "Any"
    ...
    with tab_items:
        ...
        ss["cm_selected_hand_ids"] = _normalize_hand_selection(
            new_hand_ids, items_by_id=hand_by_id, stable_order=hand_order
        )
        ss["cm_selected_weapon_upgrade_ids_by_hand"] = wu_map
    ...
    armor_upgrade_objs = [
        au_by_id[uid] for uid in (ss.get("cm_selected_armor_upgrade_ids") or []) if uid in au_by_id
    ]
    ...
    wu_map = dict(ss.get("cm_selected_weapon_upgrade_ids_by_hand") or {})
    selected_weapon_upgrade_objs: List[dict] = []
